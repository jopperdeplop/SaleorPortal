        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            ...
            <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
                    ...
                    <div className="px-4 py-5 sm:p-6">
                        {wooInt ? (
                            <div>
                                <div className="flex items-center justify-between">
                                    <div>
                                        <p className="text-sm text-gray-500">Connected to: {wooInt.storeUrl}</p>
                ...
                <div className="bg-white overflow-hidden shadow rounded-lg divide-y divide-gray-200">
                    <div className="px-4 py-5 sm:px-6 flex items-center justify-between">
                        <div className="flex items-center">
                            <h3 className="text-lg leading-6 font-medium text-gray-900">Lightspeed (X-Series)</h3>
                        </div>
                    ...
                    <div className="px-4 py-5 sm:p-6">
                        {lightspeedInt ? (
                            <div>
                                <div className="flex items-center justify-between">
                                    <div>
                                        <p className="text-sm text-gray-500">Connected to: {lightspeedInt.storeUrl}</p>
                            ...
                            <div>
                                ...
                                <form action="/api/integrations/lightspeed/auth" method="GET">
                                    <label htmlFor="shop" className="block text-sm font-medium text-gray-700 mb-1">Domain Prefix</label>
                                    <div className="flex gap-2">
                                        <input
                                            type="text"
                                            name="shop"
